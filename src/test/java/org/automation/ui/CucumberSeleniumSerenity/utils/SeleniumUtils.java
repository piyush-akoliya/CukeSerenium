package org.automation.ui.CucumberSeleniumSerenity.utils;

import org.automation.ui.CucumberSeleniumSerenity.driver.CustomDriver;
...
//    }
    ...
    public SeleniumUtils(String url) {
    	driver=new CustomDriver().newDriver();
    	driver.get(url);
    }
